...
import 'package:disaster_management/src/features/authentication/screens/SignUP/sign.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen1> {
  ...
  final mobilecontrol = new TextEditingController();
  ...
  postDetailsToFirestore() async {
    ...
    userModel.mobileNo = mobilecontrol.text;
